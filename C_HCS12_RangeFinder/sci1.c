...
//-------------------------SCI1_Init------------------------
/// This function initalises all the appropriate settings for serial input

/// Sets the baud rate, interrupt settings, also checks the clock and enables the receiver and transmitter
///@param baudRate The baud rate [BAUD_[desired baud_rate]]
...
///
/// This function uses busy waiting synchronisation to output a character to SCI1DRL.
...
///
/// This function simply outputs each character in the string till the string reaches the terminating character
/// @param *pt The string itself
/// @see SCI1_OutChar()
...
/// @param *string String to be saved into
/// @param String length
/// @see SCI1_InChar()
